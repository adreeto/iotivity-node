...
// function IotivityMagic() {
//   var self = this;
//
//   self.run = function() {
//     client.findResources().catch(handleError);
//     self.interval = setInterval(function(){client.findResources.catch(handleError)}, 5000);
//   }
//
// }
//
// module.exports = IotivityMagic;
// // do all the setUp then call dev.run()
// var url = "";
// var types = [];

// module.exports = {
//   function init(href, types) {
//     url = href;
//     types = types;
//   }
// }
...
function IoTivityWrapper() {
  self.register = function(href, resourceTypes, name) {
...
module.exports.IoTivityWrapper = IoTivityWrapper;



var serverResource; // This will be a reference to the main resource that
var clientResourceList = []; // Keep a list of all client resource that you will be listening to
var _ = {
...
if ( device.device.uuid ) {
	...
	server.register( {
		...
		console.log( "OCF resource successfully registered inside the server-base file" );
...
console.log("Issuing initial discovery request");
client.findResources().catch(handleError);
setInterval(function(){ // Check every 5 seconds for new devices.
