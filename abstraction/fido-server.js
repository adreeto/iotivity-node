...
const base = require("server-base").IoTivityWrapper;

var href = "/a/fidoServer";
var resourceTypes = ["core.authenticate"];
var name = "fido-server";

base.register(href, resourceTypes, name);
